        ...
        async getRestaurants() { 
          ...
          const delivery = serializeDeliveryData(deliveryData);
            ...
            this.isModalOpen = false; 
             ...
             scrollToMainTxt(index) {
          const mainTxt = document.getElementById(`mainTxt-${index}`);
          if (mainTxt) {
            window.scrollTo({
              top: mainTxt.offsetTop,
              behavior: "smooth"
            });
          }
        },
    ...
    <div> 
      ...
      <div v-else>
        <div v-for="restaurant in restaurants" :key="restaurant.id">
          ...
          <div v-for="(delivery, index) in deliveries" :key="delivery.id" class="prod">
            ...
            <div class="container">
              ...
              <div class="deliveryInfo">
                <img src="https://cdn.onlinewebfonts.com/svg/img_257279.png" class="bagimage">
                <h2 class="timeOfDelivery">~ {{ (delivery.lowLimitMinutes + delivery.upperLimitMinutes) /2}} мин</h2>
              </div>
              <div class="deliveryInfo">
     ...
     <div class="productsContainer slider-container" >
              <div v-for="(foodType, index) in foodTypes" :key="index" class="sliderContainer"  @click="scrollToMainTxt(index)">
                <div class='borderforcontainer'>
                <h1 class="categoryTitles">{{ foodType.title }}</h1>
              </div>
            </div>
        </div> 
  ...
  <div v-for="(foodType, index) in foodTypes" :key="index">
      <div v-for="food in foodType.foods" :key="food.id"></div>
        ...
        <div class="foodTypes">
          <div class="productsContainer">
            ...
            <h2 :id="`mainTxt-${index}`" class="mainTxt">{{ foodType.title }}</h2>
            <div>
      ...
      <div class="productImage">
        <img :src="food.logo ? food.logo : 'https://chocofood.kz/_nuxt/img/default_item.a3e53c0.svg'" :alt="food.title" class="foodlogo" />
